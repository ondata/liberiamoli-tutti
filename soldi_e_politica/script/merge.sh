...
cartella_input="${folder}/../processing/ART_5_DL_149_2013_L_3_2019_dal_01012024_al_31122024"
...
mlr --ijsonl --ocsv cat "${folder}"/../raw_data/output/ART_5_DL_149_2013_L_3_2019_dal_01012024_al_31122024_nomi_partiti.jsonl >"${folder}"/../processing/nomi_partiti.csv

mlr -S --csv join --ul -j pagina -f "${folder}"/../processing/tmp.csv then unsparsify then sort -t pagina,n then rename testo,partito then reorder -f partito "${folder}"/../processing/nomi_partiti.csv >"${folder}"/../output/ART_5_DL_149_2013_L_3_2019_dal_01012024_al_31122024.csv

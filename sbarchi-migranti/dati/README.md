...
| Data_Report | datetime | La data del report PDF, da cui sono estratti i dati |
...
| Nome colonna | Tipologia colonna | Descrizione colonna |
| ---- | ---- | ----------- |
| Data | datetime | La data dello sbarco |
...
- `datetime`: Questo tipo di campo è utilizzato per contenere date e/o orari. Nel contesto di questo dati si tratte di date in formato anno-mese-giorno (YYYY-MM-DD), come ad esempio `2020-01-18`;
